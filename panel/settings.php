...
<html lang="en-US">
	<head>
		...
		<!-- Meta -->
		<meta charset="UTF-8">
		<title>ECSO - Officer Settings</title>
		<meta name="description" content="Erie County Sheriff Office - Officer Settings">
								...
								<div class="row">
                                	...
                                	<div class="form-group col-12">
										...
										<label for="telNum">Phone Number:</label>
											<input type="text" maxlength="10" name="telNum" value="<?php echo $usr['phone']; ?>" class="form-control" id="telNum" style="width:60%">
