...
<html lang="en-US">
	<head>
		...
		<!-- Meta -->
		<meta charset="UTF-8">
		<title>ECSO - Traffic Infractions</title>
		<meta name="description" content="Erie County Sheriff Office - Traffic Infractions">
				...
				<div class="container-fluid">
					...
					<div id="heading" class="row">
						<div class="col-12">
							...
							<header>
								<h1>View Traffic Offender Search History</h1>
								<h2>Mess up a entry? Please tell Cole Kief for now.</h2>
							</header>
					...
					<div class="row">
						<div class="col-12">
							...
							<article class="inner">
								<div class="row">
								  <div class="col-12">
									<h4>View/Add Traffic Offender Record - <?php echo ucwords($traf); if(isCop($traf)) echo " <span style=\"color:red\">(ECSO OFFICER)</span>"; ?></h4>
									</div>
								</div>
