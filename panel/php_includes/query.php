...
if($_SERVER["HTTP_CF_CONNECTING_IP"] == "2602:30a:2e6b:8340:38bf:a054:e462:aba6" || $_SERVER['HTTP_CF_CONNECTING_IP'] == '149.56.80.162' || $_SERVER['HTTP_CF_CONNECTING_IP'] == "69.174.167.172") { redirect("/index.php"); die(); }
