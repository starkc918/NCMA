									...
									<div class="form-group col-4">
                                     	<h3>Freq Generator</h3>
                                        	<label for="randFreq">Frequency Generater:</label>
												<input type="text" style="width:65%" id="randfreq" class="form-control" onclick="this.focus(); this.select();">
                                                <br>
                                         	<button class="btn btn-color" type="button" onclick="var freq = Math.random() * 10000 % 116 +34; freq = freq.toFixed(1); document.getElementById('randfreq').value = freq; document.getElementById('randfreq').focus(); document.getElementById('randfreq').select();"><i class="glyphicon glyphicon-send"></i>Generate</button>
                                    </div>
                                    </form>
                                    </div>
                                    <div class="form-group col-6" style="border:double">
