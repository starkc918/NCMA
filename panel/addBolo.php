...
<html lang="en-US">
	<head>
		...
		<!-- Meta -->
		<meta charset="UTF-8">
		<title>ECSO - Add BOLO</title>
		<meta name="description" content="Erie County Sheriff Office - Add BOLO">
                              ...
                              <form id="post-comment" class="inner" action="addBolo.php" method="post">
								 <div class="row">
										<div class="form-group col-8">
										  <label for="boloInfo">BOLO Information (keep it short but specific) [IE: Black Rapter with 3 occupants, armed and dangerious.] <span class="form-required" title="This field is required.">*</span></label>
