							  ...
							  <!-- Accordion -->
								...
								<div class="panel-group" id="accordion">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion" href="#classOne" class="collapsed">Class 1 Felonys</a>
											</h4>
										</div>
										<div id="classOne" class="panel-collapse collapse">
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion" href="#classTwo" class="collapsed">Class 2 Felonys</a>
											</h4>
										</div>
										<div id="classTwo" class="panel-collapse collapse">
											<div class="panel-body">
												<p>here</p>
											</div>
										</div>
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" data-parent="#accordion" href="#classThree" class="collapsed">Class 3 Felonys</a>
											</h4>
										</div>
										<div id="classThree" class="panel-collapse collapse">
											<div class="panel-body">
												<p>here</p>
											</div>
										</div>
